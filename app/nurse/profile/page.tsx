      ...
      <div className="max-w-5xl mx-auto space-y-10">
        <div className="bg-white shadow-lg rounded-xl p-8">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-2xl font-bold text-gray-900">Nurse Profile</h2>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            ...
            />
            <Section title="Nurse Information">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card title="Addmitted Patients" icon={<Stethoscope className="w-6 h-6 text-green-600" />} onClick={() => router.push('/nurse/admitted-patients')} />
          <Card title="Dashboard" icon={<LayoutDashboard  className="w-6 h-6 text-green-600" />} onClick={() => router.push('/nurse/dashboard')} />
        </div>
      </div>
    </main>
  );
