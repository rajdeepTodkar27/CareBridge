...
export async function POST(req: NextRequest) {
    try {
        ...
        const {pastIllness,surgeries,currentMedications,allergies,geneticDisorders,pastMedicalTests}=await req.json()
        ...
        if(medHis){
            await MedicalHistory.findOneAndUpdate(medHis._id,{$set:{pastIllness,surgeries,currentMedications,allergies,geneticDisorders,pastMedicalTests,pastPrescriptions: prescription}})
